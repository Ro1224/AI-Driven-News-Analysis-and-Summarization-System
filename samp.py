...
genai.configure(api_key="AIzaSyA8pqG1Kw3yzVOraHfAUNBtJPr-4ZbjvSM")
...
# Gemini chatbot
def ask_gemini(summary, question):
    try:
        prompt = f"Based on the article summary below, answer the question:\n\n{summary}\n\nQuestion: {question}"
...
def index():
    if request.method == "POST":
        ...
        chatbot_answer = ""
        if question:
            chatbot_answer = ask_gemini(summary, question)
